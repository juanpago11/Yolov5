...
st.set_page_config(
    page_title="Detectar Objetos en Tiempo Real",
    page_icon="🔍",
    layout="wide"
)
...
st.markdown("Esta super aplicaciòn utiliza YOLOv5 para poder detectar cualquier tipo de objetos en imágenes capturadas con tu cámara. Pruebalo")
